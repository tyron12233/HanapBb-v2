...
class MessageThreadUtil<T> implements android.recyclerview.widget.ThreadUtil<T> {
                    ...
                    while (msg != null) {
                        switch (msg.what) {
                            ...
                            case ADD_TILE:
                                ...
                                android.recyclerview.widget.TileList.Tile<T> tile = (android.recyclerview.widget.TileList.Tile<T>) msg.data;
