 ...
 * list
 * such that it can be bound to a {@link android.recyclerview.widget.RecyclerView.Adapter
...
public class SortedList<T> {
    ...
    /**
     * Replaces the current items with the new items, dispatching {@link android.recyclerview.widget.ListUpdateCallback} events
     ...
     * {@link android.recyclerview.widget.ListUpdateCallback#onMoved(int, int)} events. It instead treats moves as a remove
     * followed by an add and therefore dispatches {@link android.recyclerview.widget.ListUpdateCallback#onRemoved(int, int)}
     * and {@link android.recyclerview.widget.ListUpdateCallback#onRemoved(int, int)} events.  See {@link DiffUtil} if you want
    ...
    public static abstract class Callback<T2> implements Comparator<T2>, ListUpdateCallback {
         ...
         * {@link android.recyclerview.widget.RecyclerView.Adapter RecyclerView.Adapter}, you should
         ...
         * {@link android.recyclerview.widget.RecyclerView}, you can return the particular field that
    ...
    public static class BatchedCallback<T2> extends Callback<T2> {
        ...
        private final android.recyclerview.widget.BatchingListUpdateCallback mBatchingListUpdateCallback;
        /**
