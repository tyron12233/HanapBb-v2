...
public class AsyncListUtil<T> {
    ...
    final android.recyclerview.widget.TileList<T> mTileList;

    final android.recyclerview.widget.ThreadUtil.MainThreadCallback<T> mMainThreadProxy;
    final android.recyclerview.widget.ThreadUtil.BackgroundCallback<T> mBackgroundProxy;
    ...
    public AsyncListUtil(@NonNull Class<T> klass, int tileSize,
        ...
        mTileList = new android.recyclerview.widget.TileList<T>(mTileSize);

        android.recyclerview.widget.ThreadUtil<T> threadUtil = new MessageThreadUtil<T>();
    ...
    private final android.recyclerview.widget.ThreadUtil.MainThreadCallback<T>
            mMainThreadCallback = new android.recyclerview.widget.ThreadUtil.MainThreadCallback<T>() {
        @Override
        ...
        @Override
        public void addTile(int generation, android.recyclerview.widget.TileList.Tile<T> tile) {
            if (!isRequestedGeneration(generation)) {
                if (DEBUG) {
            ...
            android.recyclerview.widget.TileList.Tile<T> duplicate = mTileList.addOrReplace(tile);
            if (duplicate != null) {
        ...
        public void removeTile(int generation, int position) {
            ...
            android.recyclerview.widget.TileList.Tile<T> tile = mTileList.removeAtPos(position);
            if (tile == null) {
    ...
    private final android.recyclerview.widget.ThreadUtil.BackgroundCallback<T>
            mBackgroundCallback = new android.recyclerview.widget.ThreadUtil.BackgroundCallback<T>() {

        private android.recyclerview.widget.TileList.Tile<T> mRecycledRoot;
        ...
        public void loadTile(int position, int scrollHint) {
            ...
            android.recyclerview.widget.TileList.Tile<T> tile = acquireTile();
        ...
        @Override
        public void recycleTile(android.recyclerview.widget.TileList.Tile<T> tile) {
            if (DEBUG) {
        ...
        private android.recyclerview.widget.TileList.Tile<T> acquireTile() {
            if (mRecycledRoot != null) {
                android.recyclerview.widget.TileList.Tile<T> result = mRecycledRoot;
                mRecycledRoot = mRecycledRoot.mNext;
                return result;
            }
            return new android.recyclerview.widget.TileList.Tile<T>(mTClass, mTileSize);
        }
        ...
        private void addTile(android.recyclerview.widget.TileList.Tile<T> tile) {
