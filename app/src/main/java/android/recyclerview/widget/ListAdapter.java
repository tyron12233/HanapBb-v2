 ...
 * <p>
 * This class is a convenience wrapper around {@link android.recyclerview.widget.AsyncListDiffer} that implements Adapter common
 ...
 * class should refer to {@link android.recyclerview.widget.AsyncListDiffer}, which provides custom mapping from diff events
...
public abstract class ListAdapter<T, VH extends RecyclerView.ViewHolder>
    ...
    final android.recyclerview.widget.AsyncListDiffer<T> mDiffer;
    private final android.recyclerview.widget.AsyncListDiffer.ListListener<T> mListener =
            new android.recyclerview.widget.AsyncListDiffer.ListListener<T>() {
        @Override
    ...
    protected ListAdapter(@NonNull DiffUtil.ItemCallback<T> diffCallback) {
        mDiffer = new android.recyclerview.widget.AsyncListDiffer<>(new android.recyclerview.widget.AdapterListUpdateCallback(this),
                new android.recyclerview.widget.AsyncDifferConfig.Builder<>(diffCallback).build());
