...
import com.tyron.hanapbb.messenger.BuildVars;
 ...
 * from the network, or from a database), {@link android.recyclerview.widget.DiffUtil} can calculate the difference between
...
public class RecyclerView extends ViewGroup implements ScrollingView,
     ...
     */
    android.recyclerview.widget.AdapterHelper mAdapterHelper;

    /**
     * Handles abstraction between LayoutManager children and RecyclerView children
     */
    public android.recyclerview.widget.ChildHelper mChildHelper;

    /**
     * Keeps data about views to be used for animations
     */
    final android.recyclerview.widget.ViewInfoStore mViewInfoStore = new android.recyclerview.widget.ViewInfoStore();
    ...
    ItemAnimator mItemAnimator = new android.recyclerview.widget.DefaultItemAnimator();
    ...
    android.recyclerview.widget.GapWorker mGapWorker;
    android.recyclerview.widget.GapWorker.LayoutPrefetchRegistryImpl mPrefetchRegistry =
            ALLOW_THREAD_GAP_WORK ? new android.recyclerview.widget.GapWorker.LayoutPrefetchRegistryImpl() : null;
    ...
    android.recyclerview.widget.RecyclerViewAccessibilityDelegate mAccessibilityDelegate;
     ...
     */
    private final android.recyclerview.widget.ViewInfoStore.ProcessCallback mViewInfoProcessCallback =
            new android.recyclerview.widget.ViewInfoStore.ProcessCallback() {
                @Override
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        setAccessibilityDelegateCompat(new android.recyclerview.widget.RecyclerViewAccessibilityDelegate(this));
     ...
     */
    @Nullable
    public android.recyclerview.widget.RecyclerViewAccessibilityDelegate getCompatAccessibilityDelegate() {
    ...
    public void setAccessibilityDelegateCompat(
            @Nullable android.recyclerview.widget.RecyclerViewAccessibilityDelegate accessibilityDelegate) {
    ...
    private void initChildrenHelper() {
        mChildHelper = new android.recyclerview.widget.ChildHelper(new android.recyclerview.widget.ChildHelper.Callback() {
            @Override
    ...
    void initAdapterManager() {
        mAdapterHelper = new android.recyclerview.widget.AdapterHelper(new android.recyclerview.widget.AdapterHelper.Callback() {
            @Override
            ...
            @Override
            public void onDispatchFirstPass(android.recyclerview.widget.AdapterHelper.UpdateOp op) {
                dispatchUpdate(op);
            }

            void dispatchUpdate(android.recyclerview.widget.AdapterHelper.UpdateOp op) {
                switch (op.cmd) {
                    case android.recyclerview.widget.AdapterHelper.UpdateOp.ADD:
                        mLayout.onItemsAdded(RecyclerView.this, op.positionStart, op.itemCount);
                        break;
                    case android.recyclerview.widget.AdapterHelper.UpdateOp.REMOVE:
                        mLayout.onItemsRemoved(RecyclerView.this, op.positionStart, op.itemCount);
                        break;
                    case android.recyclerview.widget.AdapterHelper.UpdateOp.UPDATE:
                        mLayout.onItemsUpdated(RecyclerView.this, op.positionStart, op.itemCount,
                                op.payload);
                        break;
                    case android.recyclerview.widget.AdapterHelper.UpdateOp.MOVE:
            ...
            @Override
            public void onDispatchSecondPass(android.recyclerview.widget.AdapterHelper.UpdateOp op) {
                dispatchUpdate(op);
            }
    ...
    void consumePendingUpdateOperations() {
        ...
        if (mAdapterHelper.hasAnyUpdateTypes(android.recyclerview.widget.AdapterHelper.UpdateOp.UPDATE) && !mAdapterHelper
                .hasAnyUpdateTypes(android.recyclerview.widget.AdapterHelper.UpdateOp.ADD | android.recyclerview.widget.AdapterHelper.UpdateOp.REMOVE
                        | android.recyclerview.widget.AdapterHelper.UpdateOp.MOVE)) {
    ...
    protected void onAttachedToWindow() {
        ...
        if (ALLOW_THREAD_GAP_WORK) {
            ...
            mGapWorker = android.recyclerview.widget.GapWorker.sGapWorker.get();
            if (mGapWorker == null) {
                mGapWorker = new android.recyclerview.widget.GapWorker();
                ...
                android.recyclerview.widget.GapWorker.sGapWorker.set(mGapWorker);
            }
            mGapWorker.add(this);
        }
    }
     ...
     * uses an instance of {@link android.recyclerview.widget.DefaultItemAnimator}. Whether item animations are
     ...
     * uses an instance of {@link android.recyclerview.widget.DefaultItemAnimator}.
     *
    ...
    void saveOldPositions() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (DEBUG && holder.mPosition == -1 && !holder.isRemoved()) {
                Log.e("HanapBb", String.valueOf(new IllegalStateException("view holder cannot have position -1 unless it"
    ...
    public static class RecycledViewPool {
         ...
         * constructed by {@link android.recyclerview.widget.GapWorker} prefetch from being bound to a lower priority prefetch.
         */
    ...
    public abstract static class LayoutManager {
        android.recyclerview.widget.ChildHelper mChildHelper;
         ...
         */
        private final android.recyclerview.widget.ViewBoundsCheck.Callback mHorizontalBoundCheckCallback =
                new android.recyclerview.widget.ViewBoundsCheck.Callback() {
                    @Override
         ...
         * vertical direction.
         */
        private final android.recyclerview.widget.ViewBoundsCheck.Callback mVerticalBoundCheckCallback =
                new android.recyclerview.widget.ViewBoundsCheck.Callback() {
                    @Override
                    public View getChildAt(int index) {
                        return LayoutManager.this.getChildAt(index);
         ...
         * {@link android.recyclerview.widget.LinearLayoutManager#findOneVisibleChild(int, int, boolean, boolean)},
         * and {@link LinearLayoutManager#findOnePartiallyOrCompletelyInvisibleChild(int, int)}.
         */
        android.recyclerview.widget.ViewBoundsCheck mHorizontalBoundCheck = new android.recyclerview.widget.ViewBoundsCheck(mHorizontalBoundCheckCallback);
        android.recyclerview.widget.ViewBoundsCheck mVerticalBoundCheck = new android.recyclerview.widget.ViewBoundsCheck(mVerticalBoundCheckCallback);
        ...
        /**
         * Written by {@link android.recyclerview.widget.GapWorker} when prefetches occur to track largest number of view ever
         ...
         * way. For example, the default ItemAnimator, {@link android.recyclerview.widget.DefaultItemAnimator}, will
        ...
        public boolean isViewPartiallyVisible(@NonNull View child, boolean completelyVisible,
            ...
            int boundsFlag = (android.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_GT_PVS | android.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_EQ_PVS
                    | android.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_LT_PVE | android.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_EQ_PVE);
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable,
        ...
        new android.recyclerview.widget.FastScroller(this, verticalThumbDrawable, verticalTrackDrawable,
     ...
     *
     * @see android.recyclerview.widget.LinearSmoothScroller
     */
    public abstract static class SmoothScroller {
        ...
        public interface ScrollVectorProvider {
             ...
             * can be found.
             * <p>
             * This method is used by the {@link android.recyclerview.widget.LinearSmoothScroller} to initiate a scroll towards
             * the target position.
             * <p>
     ...
     *
     * <p>By default, RecyclerView uses {@link android.recyclerview.widget.DefaultItemAnimator}.</p>
     *
    ...
    public abstract static class ItemAnimator {
         ...
         * adapter. {@link android.recyclerview.widget.DefaultItemAnimator} will skip animating the View if its location on the
