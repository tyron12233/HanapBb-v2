 ...
 * {@link android.recyclerview.widget.AsyncListDiffer} which can simplify the use of DiffUtil on a background thread.
 * <p>
...
public class DiffUtil {
    ...
    public static class DiffResult {
         ...
         * @see android.recyclerview.widget.AdapterListUpdateCallback
         */
        ...
        public void dispatchUpdatesTo(@NonNull ListUpdateCallback updateCallback) {
            final android.recyclerview.widget.BatchingListUpdateCallback batchingCallback;
            if (updateCallback instanceof android.recyclerview.widget.BatchingListUpdateCallback) {
                batchingCallback = (android.recyclerview.widget.BatchingListUpdateCallback) updateCallback;
            } else {
