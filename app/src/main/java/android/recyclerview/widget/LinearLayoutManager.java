...
//        }
    ...
    View findOneVisibleChild(int fromIndex, int toIndex, boolean completelyVisible,
            boolean acceptPartiallyVisible) {
        ensureLayoutState();
        @android.recyclerview.widget.ViewBoundsCheck.ViewBounds int preferredBoundsFlag = 0;
        @android.recyclerview.widget.ViewBoundsCheck.ViewBounds int acceptableBoundsFlag = 0;
        if (completelyVisible) {
            preferredBoundsFlag = (android.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_GT_PVS | android.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_EQ_PVS
                    | android.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_LT_PVE | android.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_EQ_PVE);
        } else {
            preferredBoundsFlag = (android.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_LT_PVE
                    | android.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_GT_PVS);
        }
        if (acceptPartiallyVisible) {
            acceptableBoundsFlag = (android.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_LT_PVE
                    | android.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_GT_PVS);
        }
    ...
    View findOnePartiallyOrCompletelyInvisibleChild(int fromIndex, int toIndex) {
        ...
        if (mOrientationHelper.getDecoratedStart(getChildAt(fromIndex))
                < mOrientationHelper.getStartAfterPadding()) {
            preferredBoundsFlag = (android.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_LT_PVS | android.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_LT_PVE
                    | android.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_GT_PVS);
            acceptableBoundsFlag = (android.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_LT_PVS
                    | android.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_LT_PVE);
        } else {
            preferredBoundsFlag = (android.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_GT_PVE | android.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_GT_PVS
                    | android.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_LT_PVE);
            acceptableBoundsFlag = (android.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_GT_PVE
                    | android.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_GT_PVS);
        }
        return (mOrientation == HORIZONTAL) ? mHorizontalBoundCheck
                .findOneViewWithinBoundFlags(fromIndex, toIndex, preferredBoundsFlag,
                        acceptableBoundsFlag) : mVerticalBoundCheck
